<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            <li class="@yield('dashboard')"><a class="nav-link" href="{{ route('home') }}"><i class="far fa-square"></i>
            ...
            <li class="nav-item dropdown @yield('Saplikasi')">
                ...
                <ul class="dropdown-menu">
                    <li class="@yield('Saplikasi')"><a class="nav-link" href="{{ route('setup.index') }}">Setup
                            Aplikasi</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown @yield('active')">
            ...
            <li class="@yield('crud')"><a class="nav-link" href="{{ route('crud') }}"><i class="far fa-square"></i>
                    <span>Crud</span></a></li>
            {{-- <li class="nav-item dropdown">
